...
query.variables('Temperature_surface','Dewpoint_temperature_height_above_ground',
                'Relative_humidity_height_above_ground','Temperature_tropopause','Apparent_temperature_height_above_ground')
query.accept('netcdf4')
nc = ncss.get_data(query)
data = xr.open_dataset(NetCDF4DataStore(nc))
data.to_netcdf('GFS_2021052501.nc','w')
shutil.move('GFS_2021052501.nc', 'work')
