...
class MyEmail(object):
    ...
    def connect_server(self):
        ...
        smtpObj.connect(self.smtp_server,port=465)
        try:
            # 连接qq邮箱服务器
...
if __name__ == '__main__':
    obj = MyEmail(sender='1419169425@qq.com', receiver='pumpsim@163.com', username='1419169425@qq.com', password='pkomkdidkgkzghai')
    for i in range(10):
