...
plt.xlabel("Month")
plt.ylabel("Year")
plt.title("Continuous Rainy Count : 1951-2020")
...
plt.xlabel("Month")
plt.ylabel("Year")
plt.title("Continuous Hot Count : 1951-2020")
...
plt.xlabel("Month")
plt.ylabel("Year")
plt.title("Continuous Cold Count : 1951-2020")
...
plt.title("Historical Weather Count : 1951-2020")
if ISTEST == False:
...
plt.title("Historical Same Day Rainy Count : 1951-2020")
...
plt.xlabel("Month")
plt.ylabel("Probability %")
plt.title("Historical Same Day Rainy and Cold Count : 1951-2020")
...
plt.xlabel("Month")
plt.ylabel("Year")
plt.title("Historical Rainy Show : 1951-2020")
...
plt.xlabel("Month")
plt.ylabel("Year")
plt.title("Historical TAVG Show : 1951-2020")
