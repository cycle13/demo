...
def excel_c(excel_filenew_dir,name_c,excel_filerank_dir):
    ...
    if sheet.cell(n, 3).value:
        if 50 >= float(sheet.cell(n, 3).value) >= 0:
            color = '00E400'
        elif 100 >= float(sheet.cell(n, 3).value) > 50:
            color = 'FFFF00'
        elif 150 >= float(sheet.cell(n, 3).value) > 100:
            color = 'FF7E00'
        elif 200 >= float(sheet.cell(n, 3).value) > 150:
            color = 'FF0000'
        elif 300 >= float(sheet.cell(n, 3).value) > 200:
            color = '99004C'
        else:
            color = '7E0023'
    else:
