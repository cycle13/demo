...
#色彩定制：24小时降水量级色标
clevs = [0.1,50.,100.,150.,200.,300.,500] #自定义颜色列表
cdict = ['#00E400','#FFFF00','#FF7E00','#FF0000','#99004C','#7E0023'] #自定义颜色列表 '#A9F090','#40B73F','#63B7FF','#0000FE','#FF00FC','#850042'
...
position.set_yticklabels((0,50,100,150,200,300,500))
...
# # # #裁切
# clip = maskout.shp2clip(cf,ax,r'haerbin/市界.shp','hrb')
clip = maskout.shp2clip(cf,ax,r'haerbin/市界.shp','hrb') #haerbin/shijie.shp  shp/黑龙江省/市界.shp

#从全国实际地图中获取辽宁省的市级边界并加载
shpname = r'haerbin/市界.shp'  # shp/country1.shp
