...
(
    ...
    .add(
        type_="effectScatter",
        series_name="pm2.5",
        # [['海门', [121.15, 31.89, 9]], ['鄂尔多斯', [109.781327, 39.608266, 12]]]
    ...
    .add_control_panel(
        scale_control_opts = opts.BMapScaleControlOpts(position=3,offset_width = 10,offset_height = 50,)
    )
    .add_schema(
        baidu_ak="TaXHPPc7HlxpjOFL3XjakmvHMbhp8YdX",
